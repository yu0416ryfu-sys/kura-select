...
faqs:
  - question: "普通の洗剤と部屋干し用洗剤の違いは？"
    answer: "**A.** 部屋干し用洗剤には、生乾き臭の原因となるモラクセラ菌を抑制する**抗菌成分**が追加配合されています。通常の洗剤でも汚れは落ちますが、部屋干し特有のニオイ対策には専用品が効果的です。"
  - question: "部屋干し洗剤を外干しに使っても問題ない？"
    answer: "**A.** まったく問題ありません。部屋干し用洗剤は抗菌成分が追加されているだけで、通常の洗濯にも使えます。外干しで使えば、より高い抗菌効果が期待できます。"
  - question: "生乾き臭がついた衣類の復活方法は？"
    answer: "**A.** 60℃以上のお湯に酸素系漂白剤を溶かし、30分〜1時間浸け置きすることで原因菌を殺菌できます。その後、通常通り洗濯して干せばニオイが取れます。"
  - question: "部屋干しで乾きを早くするコツは？"
    answer: "**A.** 洗濯物の間隔を**こぶし1個分**空ける、扇風機やサーキュレーターで**風を当てる**、除湿機を併用することで乾燥時間を大幅に短縮できます。乾燥時間が短いほど雑菌の繁殖を抑えられます。"
  - question: "すすぎ1回で本当に汚れは落ちる？"
    answer: "**A.** すすぎ1回対応の洗剤は、少ない水でも洗剤成分が残りにくい処方になっています。普通の汚れなら問題ありません。ただし、泥汚れや食べこぼしなどひどい汚れの場合はすすぎ2回がおすすめです。"
---
