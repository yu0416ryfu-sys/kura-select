...
商品には「2枚入」のように枚数だけ書かれたものと、エアークエストグリーン38（38cm×80cm）や CleAirWin（400×800mm）のように**寸法で売られているもの**があります。寸法ものはハサミで切って使う前提なので、多少大きいぶんには対応できますが、小さいと足りません**。エアコンの吸気口の縦横をメジャーで測ってから**注文してください。
