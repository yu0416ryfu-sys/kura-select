...
products:
  ...
  - rank: 9
    ...
    offers:
      - provider: "yahoo"
        label: "Yahoo!"
        url: "https://ck.jp.ap.valuecommerce.com/servlet/referral?sid=3770852&pid=892615315&vc_url=https%3A%2F%2Fstore.shopping.yahoo.co.jp%2Fmatinozakka%2F4901609005440.html"
        matchStatus: "pending"
        updatedAt: "2026-06-11"
        price: 188
        rating: 4.8
        reviewCount: 5
        imageUrl: "https://item-shopping.c.yimg.jp/i/j/matinozakka_4901609005440"
        available: true
  - rank: 10
...
faqs:
  - question: "酸性洗剤と塩素系洗剤を続けて使えるの？"
    answer: "**A.** **絶対にNG**です。酸性洗剤と塩素系洗剤が混ざると有毒な塩素ガスが発生し、非常に危険です。別の液性の洗剤を使う場合は、前の洗剤を十分に水で洗い流し、時間を空けてから使用してください。"
  - question: "トイレの黄ばみが取れない場合は？"
    answer: "**A.** 軽い黄ばみはサンポールなどの酸性洗剤を塗布して15〜30分放置し、ブラシでこすると落ちます。それでも取れない頑固な尿石は、トイレットペーパーに洗剤を染み込ませて「湿布法」で長時間密着させる方法が効果的です。"
  - question: "タンクレストイレに置き型洗剤は使える？"
    answer: "**A.** タンクレストイレには通常の置き型タイプは使用できません。代わりに「スタンプタイプ」（便器内壁に直接ジェルを貼り付けるタイプ）がおすすめです。流すたびに洗浄成分が溶け出し、同様の効果が得られます。"
  - question: "トイレブラシは使い捨てと普通のどっちがいい？"
    answer: "**A.** 衛生面では使い捨てタイプが優れていますが、1回あたりのコストが高くなります。コスパ重視なら従来型ブラシを定期的に消毒して使う方が経済的です。使い捨てタイプはブラシの衛生管理が面倒な方におすすめです。"
---
