...
faqs:
  - question: "スポンジの除菌は必要？"
    answer: "食洗機に入れるか、除菌スプレーを吹きかけて自然乾燥させるのが効果的です。電子レンジでの除菌は一部素材で変形のリスクがあるため注意してください。"
  - question: "フッ素加工のフライパンにはどのスポンジ？"
    answer: "研磨粒子のないソフトタイプ（パックスナチュロンなど）を選びましょう。スコッチ・ブライトの研磨面はフッ素コーティングを傷つける可能性があります。"
  - question: "スポンジは何個ストックしておくべき？"
    answer: "3〜6個（3〜6ヶ月分）が適量です。スポンジは未使用でも長期間置くと素材が劣化する場合があるため、半年分程度にしておきましょう。"
  - question: "食器用スポンジは何を基準に選ぶ？"
    answer: "1個あたり単価、泡立ち、水切れ、耐久性、フライパンを傷つけにくい素材かを見ます。安さだけでなく交換頻度まで含めると比較しやすいです。"
  - question: "安いスポンジと長持ちスポンジはどちらがコスパ良い？"
    answer: "交換頻度が高い家庭では安いスポンジ、1個を長く使いたい家庭では耐久性の高いスポンジが向きます。月1回交換を目安に年間コストで比べましょう。"
---
