...
products:
  ...
  - rank: 9
    ...
    rating: 5
    reviewCount: 1
    imageUrl: "https://thumbnail.image.rakuten.co.jp/@0_mall/cavatina/cabinet/pt20260615-1/ralph-117.jpg?_ex=128x128"
  - rank: 10
...
毎日使える実用品が無難です。名入れボールペン、靴下、ハンカチ、マグカップのようなアイテムは、年齢や好みを問わず選びやすいです。

### 予算の目安はどれくらい？

気軽な贈り物なら低価格帯、きちんと感を出したいなら中価格帯が選びやすいです。相手との関係性や、ほかの家族と予算をそろえるかどうかでも決めやすくなります。

### 実用性と特別感、どちらを優先すべき？

迷ったら実用性を優先すると外しにくいです。そこに名入れやブランド感を足すと、父の日らしい特別感も出しやすくなります。

### お酒を飲まない父親には何が向いている？

ボールペン、靴下、ハンカチ、マグカップのような日用品が選びやすいです。晩酌系を避けるだけで、かなり候補を絞りやすくなります。
