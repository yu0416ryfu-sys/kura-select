...
faqs:
  - question: "漂白剤は毎回の洗濯に使うべき？"
    answer: "**A.** 酸素系液体タイプなら毎回使ってOKです。除菌・消臭効果で部屋干し臭の予防にもなります。粉末タイプのつけ置きは汚れが気になる時だけで十分です。"
  - question: "色柄物に漂白剤を使って大丈夫？"
    answer: "**A.** **酸素系なら色柄物に使えます**。ただし初めて使う衣類は目立たない部分で色落ちテストをしてから使いましょう。塩素系は絶対に色柄物に使わないでください。"
  - question: "オキシクリーンのつけ置きは何度のお湯？"
    answer: "**A.** **40〜60℃のお湯**が最も効果的です。水では過炭酸ナトリウムの溶解が遅く、効果が出にくくなります。熱すぎるお湯（80℃以上）は衣類を傷める可能性があります。"
---
...
| 商品 | 1回あたり | 年間コスト（365回） |
|------|----------|-------------------|
| ブライトSTRONG | 約8.0円 | **約2,920円** |
| ワイドハイターEX | 約8.2円 | **約2,993円** |
| オキシクリーン | 約14.4円 | **約5,256円** |
| シャボン玉 | 約14.9円 | **約5,439円** |
...
**A.** 酸素系液体タイプなら毎回使ってOKです。除菌・消臭効果で部屋干し臭の予防にもなります。粉末タイプのつけ置きは汚れが気になる時だけで十分です。

**Q. 色柄物に漂白剤を使って大丈夫？**

**A.** **酸素系なら色柄物に使えます**。ただし初めて使う衣類は目立たない部分で色落ちテストをしてから使いましょう。塩素系は絶対に色柄物に使わないでください。

**Q. オキシクリーンのつけ置きは何度のお湯？**

**A.** **40〜60℃のお湯**が最も効果的です。水では過炭酸ナトリウムの溶解が遅く、効果が出にくくなります。熱すぎるお湯（80℃以上）は衣類を傷める可能性があります。

## まとめ

衣料用漂白剤選びでは、「毎日の洗濯用」と「つけ置き用」で使い分けるのがベストです。毎日使いにはブライトSTRONGまたはワイドハイターEX（年間約3,000円）、週末のつけ置きケアにはオキシクリーンを組み合わせましょう。洗濯洗剤・柔軟剤と合わせてランドリーのトータルコストを最適化できます。
