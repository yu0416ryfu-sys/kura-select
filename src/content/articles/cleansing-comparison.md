...
| 商品 | 容量 | タイプ |
|------|------|-------|
| ビオレ クレンジングウォーター | 300mL | ウォーター |
| ソフティモ オイルクレンジング | 230mL | オイル |
| キュレル クレンジングフォーム | 150mL | フォーム |
| DHC プレミアムクレンジングオイル | 200mL | オイル |

コスパ最強はビオレ クレンジングウォーターですが、メイクが濃い方は洗浄力の高いオイルタイプがおすすめです。DHCはクレンジング品質と洗い上がりの良さで定評があり、1本長く使えることを考えると実質コスパは悪くありません。

## まとめ

クレンジング選びは「メイクの濃さ」と「肌質」に合わせることが最も重要です。コスパ最強はビオレ クレンジングウォーターで、ライトメイクの方に最適。フルメイク派にはDHCや ソフティモのオイルタイプ、敏感肌・乾燥肌の方にはキュレルのクレンジングフォームがベストマッチです。大容量タイプをまとめ買いすることで年間のスキンケアコストを抑えることができます。
