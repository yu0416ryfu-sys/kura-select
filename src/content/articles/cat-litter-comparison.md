...
description: "猫砂を鉱物系・木炭系・おから系・紙系・木質ペレットで素材別に比較。固まりやすさ・消臭力・1Lあたりの単価を基準におすすめ10商品を徹底比較。楽天まとめ買いコスパ最強まとめ。"
category: "cat-litter"
...
products:
  - rank: 1
    ...
    imageUrl: "https://thumbnail.image.rakuten.co.jp/@0_mall/kurosu/cabinet/rakulogo/rakulogo13/r1301_00028.jpg?_ex=128x128"
    offers:
      - provider: "yahoo"
        label: "Yahoo!"
  ...
  - rank: 2
    ...
    rakutenUrl: "https://hb.afl.rakuten.co.jp/hgc/g00pr3zn.3rdw6223.g00pr3zn.3rdw78bd/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fdog-kan%2Fa533439%2F&m=http%3A%2F%2Fm.rakuten.co.jp%2Fdog-kan%2Fi%2F10002747%2F&rafcid=wsc_i_is_42b71141-7589-447e-ab9f-1c5e97e9d61f"
    imageUrl: "https://thumbnail.image.rakuten.co.jp/@0_mall/dog-kan/cabinet/11076425/11076426/a533439.jpg?_ex=128x128"
    offers:
      - provider: "yahoo"
        label: "Yahoo!"
  ...
  - rank: 4
    ...
    pros:
      - "国産素材を選びたい方に向く"
      - "トイレに流せるため処理の手軽さを重視する方に適している"
      - "植物系で廃棄の融通が利きやすい"
    cons:
      - "鉱物系に比べて固まりが柔らかめの場合がある"
    ...
    imageUrl: "https://thumbnail.image.rakuten.co.jp/@0_mall/kurosu/cabinet/rakulogo/rakulogo13/r1301_00227.jpg?_ex=128x128"
    offers:
      - provider: "yahoo"
        label: "Yahoo!"
  ...
  - rank: 6
    ...
    features:
      ...
      - "崩れるタイプで使用後は木くず状になる"
    pros:
      - "天然木素材で添加物を抑えた自然派志向の方に向く"
      - "システムトイレ対応で専用機器使用者が選びやすい"
      - "燃えるゴミに出せる地域が多く廃棄の手軽さがある"
    cons:
      - "システムトイレ非使用の場合は相性の確認が必要"
      - "無香料のため好みによっては消臭感が物足りない場合がある"
  ...
  - rank: 7
    ...
    features:
      ...
      - "使用時のホコリを抑えた処方"
    pros:
      - "大手ブランドの品質安定性と入手しやすさが特徴"
      - "固まりが硬く処理しやすい鉱物系の使い勝手"
      - "ホコリが抑えられており猫のトイレ環境を整えやすい"
    cons:
      - "鉱物系のため重量があり保管・廃棄に場所が必要"
      - "燃えないゴミとして処理する地域が多い"
  ...
  - rank: 8
    ...
    features:
      ...
      - "飛び散り防止のペレット形状"
    pros:
      - "固まりが硬く処理しやすい鉱物系の定番モデル"
      - "抗菌機能でトイレ周りの衛生を保ちやすい"
      - "国内大手ブランドで安定した品質と入手しやすさがある"
    cons:
      - "鉱物系のため重量があり保管・廃棄場所の確保が必要"
      - "燃えないゴミとして処理する地域が多い"
  ...
  - rank: 10
    ...
    features:
      ...
      - "優れた固まり性能と消臭力で海外でも評価実績のあるブランド"
    pros:
      - "細粒タイプで猫が掘りやすく自然な使用感を好む猫に向く"
      - "固まりがしっかりしており処理時に崩れにくい"
      - "香りのバリエーションから好みに応じて選びやすい"
    cons:
      - "鉱物系のため重量があり保管・廃棄場所の確保が必要"
    ...
    imageUrl: "https://thumbnail.image.rakuten.co.jp/@0_mall/kurosu/cabinet/rakulogo/rakulogo13/r1301_00229.jpg?_ex=128x128"
    offers:
      - provider: "yahoo"
        label: "Yahoo!"
...
猫砂で最も痛い買い間違いは、**トイレの方式に合わない素材を大量に買ってしまう**ことです。素材の好みより先に、いま使っているトイレがどちらかを確認してください。

- **固まるタイプを入れる通常トイレ**: 尿を吸って固まった塊をスコップですくい、減った分を足していきます。比較表の鉱物系・紙系・おから系の多くがこれにあたります
- **すのこ付きのシステムトイレ**: 尿はすのこを通してシート側に落ちる前提なので、**固まる砂を入れると詰まります**。こちらには専用のチップやペレットが必要です

袋の表記が「固まる」か「システムトイレ用」かは必ず見てください。ここを間違えると、届いた分は使い道がありません。

### 素材ごとに変わるのは「捨て方」

消臭力や固まりの硬さ以上に、日々の負担を左右するのが廃棄方法です。

- **紙系**（紙でつくったねこ砂／アイリスオーヤマ 紙の猫砂）は軽く、可燃ごみに出せる自治体が多いタイプ。持ち運びと廃棄の負担がいちばん小さく、集合住宅で扱いやすい素材です
- **木質・木炭系**（パインウッド、炭の猫砂）も可燃ごみ向き。木の香りで臭いをまぎらわせる設計のものが多くあります
- **おから系**（トフカスサンドK、おからでつくったねこ砂）はトイレに流せる表記の製品が中心。ただし**流せるかどうかは配管と自治体のルール次第**で、集合住宅では禁止されている場合があります。管理規約を先に確認してください
- **鉱物系**（エバークリーン、ウッディフレッシュ）は固まりが硬く処理は楽ですが、**燃えるごみに出せない自治体が多く**、重いので買い置きと廃棄の取り回しに体力を使います

### 猫が受け付けなければ全量が無駄になる

猫は砂の粒の大きさと足触りに強い好みがあります。長年使ってきた素材から急に変えると、トイレを避けて別の場所で用を足すことがあります。**銘柄を変えるときは、いまの砂に少しずつ混ぜて数週間かけて移行する**のが確実です。まとめ買いは、その猫が受け入れると分かってからにしてください。

## 単価の比べ方と、まとめ買いの上限

猫砂は素材によって重さとかさが大きく違うため、**同じ単位に揃えないと比較になりません**。比較表の単価は容量（L）で揃えてありますが、素材をまたぐときは次の点を頭に入れて読んでください。

- 鉱物系は重量あたりのかさが小さく、**体積で比べると割高に見えます**。一方で1回あたりに使う量は少なく済みます
- 紙系・木質系は軽くかさがあるため体積では安く見えますが、**吸収したあとの交換頻度**まで含めないと実際の消費量は分かりません
- 結局のところ「1か月に何袋減るか」が答えです。いまの銘柄で1か月に使う袋数を数えておくと、他素材と比べたときの誤差がなくなります

### 買い置きが利かなくなる条件

- **保管場所を取る**。7L×8袋のような大容量セットは段ボール1箱ぶんの体積があります。湿気のこもる場所に置くと紙系・木質系は固まりや崩れが起きやすくなります
- **多頭飼いかどうかで消費が数倍変わる**。猫が2匹いればトイレも砂の消費も単純に倍以上になります
- **初めての銘柄は少量から**。前の項目のとおり猫が受け付けないリスクがあるので、いきなり8袋セットを買わないでください

### 消臭シートやトイレ本体との組み合わせも見る

システムトイレを使っている場合、砂だけでなく専用シートの費用も毎月かかります。**砂の単価だけを下げても、シート込みの月額では逆転する**ことがあるので、いま使っている組み合わせの合計で考えてください。
...
同じ猫まわりでは [キャットフードの比較](/articles/cat-food-comparison/) も扱っています。犬を飼っている方は [ドッグフードの比較](/articles/dog-food-comparison/) もどうぞ。
