...
description: "毎日のボディケアに使うローション・ボディミルクをmLあたり単価で比較。植物由来・敏感肌向け・セラミド系など人気10商品を成分と使いやすさで比較します。"
...
products:
  ...
  - rank: 2
    ...
    reviewCount: 14
    features:
      - "植物由来成分配合の無添加ボディミルク（ハニーオレンジの香り）"
      - "子供から大人まで使えるやさしい処方設計"
      - "大容量ボトルで家族全員でのシェア使いに対応した設計"
    pros:
      - "ボタニカル系・植物由来成分好きな人が選びやすい"
      - "ハニーオレンジの甘くフルーティな香りで入浴後の気分転換にも向く"
      - "大容量で家族でシェアして使いやすい"
    cons:
      - "香りが特徴的なため、無香料や香り控えめを好む人には向かない"
      - "ミルクタイプのためクリームに比べ保湿の持続はやや短め"
  ...
  - rank: 5
    ...
    reviewCount: 4
    features:
      - "セラミド配合の薬用（医薬部外品）スキンミルクで全身に使える保湿設計"
      - "乾燥・ダメージを受けた肌のバリア機能を補う処方"
      - "大容量ボトルで全身へたっぷり使いやすい設計"
    pros:
      - "薬用処方のため乾燥が気になる敏感肌の人が選びやすい"
      - "セラミド配合で肌のバリアケアにこだわりたい人に向く"
      - "全身用の大容量タイプで毎日使いしてもコスパよく継続しやすい"
    cons:
      - "薬用スキンミルクのため、香りや特別な使用感よりもシンプルな保湿重視の設計"
      - "医薬部外品のためシンプルなパッケージで演出感は少なめ"
    recommendedFor: "乾燥・ダメージ肌のバリアケアを重視したい人・薬用処方で安心して使いたい人"
    rakutenUrl: "https://hb.afl.rakuten.co.jp/hgc/g00r136n.3rdw697f.g00r136n.3rdw7383/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Frakuten24%2F4971710568530%2F&m=http%3A%2F%2Fm.rakuten.co.jp%2Frakuten24%2Fi%2F11224121%2F&rafcid=wsc_i_is_42b71141-7589-447e-ab9f-1c5e97e9d61f"
    imageUrl: "https://thumbnail.image.rakuten.co.jp/@0_mall/rakuten24/cabinet/530/4971710568530.jpg?_ex=128x128"
    offers:
      - provider: "yahoo"
        label: "Yahoo!"
  ...
  - rank: 6
    ...
    reviewCount: 0
    features:
      - "セラミド機能成分配合の全身用保湿ローション（医薬部外品）"
      - "無香料・無着色・アルコールフリーの低刺激性処方"
      - "さらっとなじむテクスチャーの大容量ボトルタイプ"
    pros:
      - "敏感肌・乾燥肌向け設計で肌への刺激が気になる人が選びやすい"
      - "無香料のため香りが苦手な人も日常使いしやすい"
      - "大容量で毎日全身に使っても長持ちしやすい"
    cons:
      - "さらっとしたテクスチャーのため、ひどい乾燥部位には別途クリームが必要な場合も"
      - "医薬部外品成分配合の設計でリッチな香りや使用感の演出はない"
...
tags:
  ...
  - "乾燥肌 保湿"
faqs:
  - question: "ボディローションとボディミルクの違いは何ですか？"
    answer: "主な違いはテクスチャー（質感）です。ローションはさらっとした水分多めのタイプ、ミルクは乳液に近い水分と油分がバランスよく入ったタイプです。どちらも全身保湿に使えますが、べたつきを避けたい場合はローション、しっとり感を重視するならミルクが向きやすいです。"
  - question: "お風呂上がりのどのタイミングで使うのがよいですか？"
    answer: "体を拭いてすぐ、肌がまだ少し湿っている状態で塗るのが一般的です。水分が残っていることで成分がなじみやすくなります。ただし製品によって推奨タイミングが異なるため、使用方法を確認してください。"
  - question: "敏感肌でも使えるものはどれですか？"
    answer: "無香料・無着色・アルコールフリーの処方を選ぶのが基本です。医薬部外品や低刺激性テスト済みの表記がある製品も参考になります。肌に合うかどうかは個人差があるため、初めて使う場合は少量でパッチテストするのがおすすめです。"
  - question: "保湿効果を長持ちさせるコツはありますか？"
    answer: "入浴後なるべく早く塗ること、乾燥が気になる部位にはローション・ミルクだけでなくクリームを重ねることが効果的です。また加湿器を使うなど室内環境も乾燥に影響します。\r\n\r\n---"
---

## ボディローションの選び方ガイド

### テクスチャーで選ぶ：ローション・ミルク・クリーム

ボディケア保湿剤は大きく3つのテクスチャーに分けられます。

**ローションタイプ**はさらっとした水分中心の処方で、塗り広げやすく夏や汗をかきやすい季節に使いやすい傾向があります。

**ミルクタイプ**は水分と油分のバランスがとれた乳液状で、ベタつきが少なくオールシーズン使いやすい設計が多いです。

**クリームタイプ**は油分が多くリッチな保湿力が特徴です。乾燥がひどい部位のスポットケアや冬場の集中保湿向きです。

### 成分で選ぶ：セラミド・ヒアルロン酸・植物由来

**セラミド**は肌のバリア機能を補う成分として知られ、敏感肌・乾燥肌向けの処方に多く配合されています。**ヒアルロン酸**は保水効果が高く、水分を肌に引き寄せる役割を担います。**植物由来成分**は原材料にこだわりたい人に選ばれやすい傾向があります。

### 香りと使うタイミング

毎日使うものなので、香りの好みは継続しやすさに直結します。無香料タイプは香りを重ねたい人にも使いやすく、就寝前専用のナイトケアタイプは香りがリラックス目的に設計されているものが多いです。

---

## 塗るタイミングが決まっている商品がある

ボディローションは容量が大きく単価も比べやすい一方で、**使う場面が決まっている商品が同じ表に混ざっています**。買う前に次の3点を確認してください。

### 風呂上がりに塗るものか、風呂の中で使うものか

ビオレu お風呂で使ううるおいミルクのような**インバス（浴室内）タイプ**は、体を洗ったあとの濡れた肌になじませて洗い流す、あるいは軽く拭き取る使い方を前提にしています。タオルで拭いてから塗る通常のローションとは手順が違うので、同じつもりで買うと使い方に戸惑います。逆にインバスタイプは「拭いたあとに塗る手間」がないぶん、続けやすいという人もいます。

### 薬用（医薬部外品）か、化粧品か

セラミエイド 薬用スキンミルクやキュレル ローションのように「薬用」と表示されたものは医薬部外品にあたり、有効成分と効能の表示が定められています。表示のないものは化粧品です。**どちらが優れているという話ではなく、表示の枠組みが違う**ので、選ぶときは自分が求めている表示があるかで見てください。

### 香りの強さ

エリザベスアーデン グリーンティー ボディローションのようにフレグランス性の高い製品は、香水のように香りが残ります。無香料を選びたい日や、職場・就寝前に使いたい場合は、無香料表示のあるビオレu や、ベビー向け・低刺激をうたう製品のほうが扱いやすくなります。**500mL級の大容量で香りが合わないと、使い切るのはかなりの苦行です**。

### 顔にも使うか

体用として作られたものを顔に使うことは想定されていない製品が多くあります。顔にも使いたい場合は、そう明記されたものを選んでください。


---
## 大容量が有利になる条件、ならない条件

ボディケアは全身に使うぶん1回の使用量が多く、単価差がそのまま年間コストに出ます。ただし**大容量が常に得とは限りません**。

- **季節で消費が数倍変わる**。乾燥する冬は毎日全身、夏は手足だけという人が多く、年間を通した平均で在庫を計算すると余ります
- **開封後に使い切る期間の目安がある**。半年〜1年を超えて残っているものは、分離やにおいの変化が出ていないか確認してください
- **香りと使用感が合うと分かってから量を増やす**。初めての銘柄をいきなり500mL×3本で買うと、合わなかったときの損失が大きくなります

### 詰め替えの有無で2本目以降が変わる

ママフィ 潤いミルキーローションのように**つめかえ用が用意されている**製品は、本体を1つ買えばあとは詰め替えで回せます。長く同じ銘柄を使う予定なら、詰め替えがあるかどうかは単価表よりも効いてきます。

### ポンプかチューブかで使い切りやすさが違う

大容量ボトルはポンプ式が多く、片手で出せて風呂上がりに使いやすい反面、**底のほうが吸い上げられずに残る**ことがあります。最後まで使うなら、残り少なくなったら小さな容器に移すか、ボトルを傾けて置いておくと無駄が出ません。チューブ式は最後まで絞り切れますが、両手を使う必要があります。

**具体的な価格・容量・1mLあたりの単価は、ページ上部の比較表（自動更新）でご確認ください**。


---
## まとめ

ボディローション・ボディミルク選びは、テクスチャー・成分・香り・容量あたりの単価の4点を軸に考えると選びやすくなります。敏感肌なら低刺激処方を、コスパを重視するなら大容量を、就寝前ケアを習慣にしたいならナイトケア設計を基準に選ぶのがポイントです。

全身の保湿では、手肌に [ハンドクリームの比較](/articles/hand-cream-comparison/)、日中の紫外線対策に [日焼け止めの比較](/articles/sunscreen-comparison/) もあわせてどうぞ。
