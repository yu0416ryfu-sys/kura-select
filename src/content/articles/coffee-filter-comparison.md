...
tags:
  ...
  - "まとめ買い"
faqs:
  - question: "コーヒーフィルターは漂白と無漂白、どちらがおいしい？"
    answer: "コーヒーの風味への影響は非常に小さく、多くの場合は大きな差を感じにくいとされています。気になる方は使用前に熱湯でリンスする（湯通しする）と紙のにおいを軽減できます。"
  - question: "メリタとカリタのフィルターは互換性がある？"
    answer: "形状は同じ台形ですが、サイズが若干異なります。同じサイズ品番（例: メリタ1×2とカリタ102）であればほぼ同等の大きさですが、確実な互換性を求めるなら使用するドリッパーのメーカーに対応したフィルターを選ぶのが安心です。"
  - question: "ハリオ V60のフィルターは他のドリッパーに使える？"
    answer: "V60専用の円錐型フィルターは他の円錐型ドリッパーと互換性がある場合もありますが、ドリッパーの角度やサイズによって合わないこともあります。メーカー推奨のフィルターを使用するのが安定した抽出につながります。"
  - question: "コーヒーフィルターのまとめ買いはお得？"
    answer: "楽天市場では100枚入り×複数パックのセットが多く、単品購入より1枚あたりの価格が15〜25%程度安くなるケースが多い傾向があります。送料無料のセットを選ぶとさらにお得です。フィルターは開封しなければ長期保存できるため、コスパを重視するならまとめ買いがおすすめです。"
---
