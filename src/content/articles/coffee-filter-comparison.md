...
ドリッパーは台形と円錐で構造が違い、フィルターは対応する形にしか収まりません。台形のドリッパーに円錐フィルターを入れると隙間から湯が抜け、注いだ量に対して薄い仕上がりになります。

台形にはさらに1つ穴と3つ穴があり、サイズ表記（101、102 など）も別物です。**買う前にドリッパー本体の型番と対応サイズを確認する**ことが、フィルター選びで最初にやることになります。

## 杯数表記はドリッパーの容量であって、好みの量ではない

「1〜2杯用」「2〜4杯用」はドリッパーの大きさに対応する表記です。大は小を兼ねません。大きいフィルターを小さいドリッパーに折り込むと、余った紙が湯に浸かって雑味の原因になります。

逆に、いつも2杯淹れるのに1〜2杯用を使うと粉に対して紙の高さが足りず、湯を注ぎ足したときに粉が縁を越えます。ふだん淹れる杯数を基準に選んでください。

## 漂白・無漂白と素材の違い

無漂白（みさらし）は塩素を使わずに作られたもので、紙のにおいが残ることがあります。気になる場合は、粉を入れる前に湯を通して紙を濡らしておくと軽減できます。この湯通しは漂白タイプでも抽出を安定させます。

布やリネンのフィルターはコーヒーの油分を通すため口当たりが変わります。ただし使うたびに洗い、濡らしたまま保管する必要があり、紙のように使い捨てにはできません。**手間を許容できる人向け**です。

## まとめ買いの前に

枚数の多いパックは1枚あたりでは有利ですが、紙は湿気とにおいを吸います。台所の引き出しに入れっぱなしにすると、次に開けたときに香りが移っていることがあります。密閉できる容器に移せる量かどうかで決めてください。

ドリッパーを買い替える予定があるなら、大量のストックは足かせになります。形が変われば手持ちのフィルターは使えません。
...
来客時やアウトドアでまとめて使うなら [使い捨て食器の比較](/articles/disposable-tableware-comparison/)、日常のお茶まわりは [ティーバッグの比較](/articles/tea-bag-comparison/) も扱っています。
