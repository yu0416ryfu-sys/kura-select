...
日中に合っているパンツ型が、夜や長時間の外出でも足りるとは限りません。1枚が吸える量は変わらないので、替えられない時間が長いほど条件が厳しくなります。

- **夜**: 朝まで替えないなら、日中と同じ感覚では足りないことがあります。夜だけ夜用や厚手のラインに切り替えると、日中の分をやりくりしやすくなります
- **長時間の外出・帰省**: 替える場所が限られるぶん、日中より余裕をみます。パンツ型は立ったままでも替えられるので、この場面ではテープ型より扱いやすいです
- **プールや水遊び**: 通常のおむつは水を吸って重くなります。水遊び用は別の商品なので、Mサイズの手持ちで代用しようとしないほうがいいです

夜だけ別のラインにすると管理する種類は増えますが、朝の着替えとシーツの洗濯が減るぶん、手間はむしろ減ります。

## この記事が向いていない人

- **まだテープ型のほうが合う時期**: 寝返りが始まっておらず、おむつ替えで嫌がらないなら、無理にパンツ型へ移る理由はありません。テープ型は [テープ型おむつ Mサイズの比較](/articles/diaper-tape-m-comparison/) で扱っています
- **すでにLサイズが近い**: ウエストのゴム跡や太もものきつさが出ているなら、Mサイズをまとめ買いするより [パンツ型おむつ Lサイズの比較](/articles/diaper-pants-l-comparison/) を先に見たほうが無駄が出ません
- **肌トラブルを解決したい**: かぶれや発疹が続いているときは、商品を選び直す前に受診してください。この記事は選び方とコストの話に限っています

使用済みおむつのにおい対策は [おむつ用防臭袋の比較](/articles/deodorizing-bag-comparison/) にまとめています。
