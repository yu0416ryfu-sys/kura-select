...
## 業務用の大容量と詰め替えでは扱いやすさが違う

大容量ボトルは単価で有利ですが、4L級は重く、洗濯機の横で片手で注ぐのは現実的ではありません。別の計量ボトルに小分けする手間が前提になります。

詰め替えパックは軽い代わりに、注ぐときにこぼしやすく開封後は自立しません。どちらを選ぶかは単価ではなく、置き場所と毎回の動作で決めてください。詰め替え用の広口ボトルを1本用意すると、この差はかなり縮みます。

## 洗濯機の投入方法で選べる形が決まる

自動投入タンク付きの洗濯機では、粘度の高い超濃縮タイプが対応外になっている機種があります。大容量を買う前に、取扱説明書の対応表記を確認してください。

手入れの都合もあります。自動投入タンクは銘柄を変えるたびに洗浄が必要なので、香りを使い分ける家庭ではむしろ手投入のほうが手間が少なくなります。

ドラム式は使用水量が少なく、規定量を超えると溶け残りやすくなります。「多めに入れて香りを強くする」は、べたつきと吸水性の低下につながります。

## 香りは強さより「重ならないこと」

洗剤・柔軟剤・消臭スプレー・アイロン用のミストがそれぞれ香り付きだと、組み合わせで意図しないにおいになります。香り重視の柔軟剤を選ぶなら、洗剤側は無香料に寄せるほうが結果が安定します。

部屋干しが中心の家庭では、香りで上書きするより乾く速さが効きます。乾くまでに時間がかかるほど菌由来のにおいは出るので、干し方を整えるほうが確実です。

## まとめ買いで気をつけること

- **保管場所**: 直射日光を避けて常温で。屋外の物置は温度変化が大きく向きません
- **使用期限**: 未開封で約3年、開封後は半年〜1年が目安と言われています
- **適量を守る**: 入れすぎると衣類のべたつきや吸水性低下の原因になります
